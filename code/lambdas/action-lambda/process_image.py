...
def image_to_text(image_name, text) -> str:
    ...
    system_prompt = """Provide a brief descrition of the image. If there a visible product id, call it out. If no product is visible, call out which of the following categorie the image belongs to: ['Hammer', 'Screwdriver', 'Wrench', 'Drill', 'Saw', 'Pliers', 'Chisel', 'Level', 'Tape Measure', 'Utility Knife', 'Other']

    
    Return the description and mention any product id if it exists, as well as the appropriate category.
    """
